//! Telemetry emission for integration_health_signal
//!
    ...
    async fn background_emitter(mut receiver: mpsc::Receiver<IntegrationHealthSignal>) {
        ...
        while let Some(signal) = receiver.recv().await {
            info!(
                ...
                "Emitting integration health signal"
            );
...
impl RuvectorClient {
    ...
    pub async fn emit_batch(&self, batch: &IntegrationHealthSignalBatch) -> Result<(), String> {
